...
export const isPasswordProvided = async (req, res, next) => {
...
export const isEmailRegisteredOrProvided = async (req, res, next) => {
...
export const isUserIdRegisteredOrProvided = async (req, res, next) => {
...
export const isUserIdProvided = async (req, res, next) => {
    const userIdReq = req.body.userId;
